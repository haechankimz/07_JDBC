...
public class DepartmentView {
	...
	private void insertDepartment() throws SQLException {
		...
		System.out.print("부서코드(deptId) 입력 : ");
		String deptId = sc.next();

		System.out.print("부서코드(deptTitle) 입력 : ");
		String deptTitle = sc.next();
		
		System.out.print("부서코드(locationId) 입력 : ");
	...
	private void  deleteDepartment() throws SQLException {
		...
		// -> 없을 경우 "부서 코드가 일치하는 부서가 존재하지 않습니다."
		
		int check = dao.checkDepartment(deptId); // 있으면1, 없으면0
